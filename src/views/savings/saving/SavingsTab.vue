                                        ...
                                        <v-col sm="2" cols="2" class="">
                                            ...
                                            >
                                                ...
                                                <v-list width="200px" class="pa-3">
                                                    <v-list-item link route to="saving_account">
                                                        <v-list-item-title>{{$t('add_saving_account')}}</v-list-item-title>
                                                    </v-list-item>
                                                    <v-list-item link route to="saving_deposit">
                                                        <v-list-item-title>{{$t('saving_deposits')}}</v-list-item-title>
                                                    </v-list-item>
                                                    <v-list-item link route to="withdraw">
                                                        <v-list-item-title>{{$t('saving_withdraws')}}</v-list-item-title>
                                                    </v-list-item>
                                                    <v-list-item link route to="close_month">
                                                        <v-list-item-title>{{$t('interest_calculation')}}</v-list-item-title>
                                                    </v-list-item>
                                                    <v-list-item link route to="close_saving">
                                                        <v-list-item-title>{{$t('close_saving')}}</v-list-item-title>
                                                    </v-list-item>
                                                </v-list>
                                            </v-menu>
                                        </v-col>
...
export default {
    name: "Customers",
    components: {
        SavingsCenter: () => import("./saving_center/SavingsCenter"),
