                        ...
                        <v-row>
                            ...
                            <v-col sm="4" cols="12" class="pt-0">
                                <v-card outlined dense
                                    ...
                                    <h3 class="text-left text-uppercase font_13 flex-1">{{ $t('amount_of_savings') }}</h3>
                            ...
                            <v-col sm="4" cols="12" class="pt-0">
                                <v-card outlined dense
                                        class="pa-3 no_border white--text d-flex justify-space-between align-center"
                                        color="third" height="80px">
                                    <h3 class="text-left text-uppercase font_13 flex-1">{{ $t('interest_on_savings') }}</h3>
