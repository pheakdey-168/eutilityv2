                                        ...
                                        <v-col sm="12" cols="12">
                                            ...
                                            <v-row>
                                                ...
                                                <v-col sm="6" cols="6" class="py-0">
                                                    <label class="label">{{ $t('bill_no') }}</label>
                                                ...
                                                <v-dialog v-model="dialogM3" max-width="550px">
                                                    ...
                                                    <v-card>
                                                        ...
                                                        <v-card-actions class="function_footer">
                                                            <v-btn class="btn_cancel float-left ml-4 mb-2"
                                                                   @click="dialogM3 = false">{{ $t('cancel') }}
                                                            </v-btn>
                                                            <v-btn class="btn_save_close float-right mr-4 mb-2"
