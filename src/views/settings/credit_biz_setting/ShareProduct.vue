                    ...
                    <v-card>
                        ...
                        <v-card-text style="height: 600px; background-color: #EDF1F5; color: #333333;">
                            <v-row>
                                ...
                                <v-col sm="6" cols="12" class="pb-0">
                                    <label class="label  mb-0">{{$t('maximum_sell_to_a_member')}}</label>
                                    <v-row>
                                        <v-col sm="1" cols="12" class="py-0">
                                            <v-checkbox
                                        ...
                                        <v-col sm="4" cols="12" class="py-0" v-show="p.allowShareAmount">
                                            <v-select
                                                :disabled="!p.allowMaxSell"
                                                class="mt-1"
                                                :items="maxSellTyps"
        ...
        async save() {
            ...
            new Promise(resolve => {
                setTimeout(() => {
                    resolve('resolved')
                    this.showLoading = true
                    if(this.p.allowShareAmount == false){
                        this.p.shareAmount = 0
                    }
                    window.console.log(this.p.allowShareAmount, this.p.shareAmount, 'check1')
