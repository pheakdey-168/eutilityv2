                    ...
                    <v-row>
                        <v-col class="py-0 px-md-2" sm="4" cols="12">
                            ...
                            <v-card
                                ...
                                min-height="338"
                                >
                                <h3 class="font_20 pb-1">{{ $t("total_loan_amount") }}</h3>
                                <p class="mb-0">{{ $t("total_loan_description") }}</p>
                                <h2 class="primary--text mb-0 niradei_black pa-0 col-sm-12 text-right">{{totalLoan}}</h2>
                                <v-row>
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <v-btn :to="lang+'/credit_biz/loan_agreement'" class="mt-2 text-capitalize font_16 rounded-0 white--text"  color="primary">
                                            + {{$t('loan')}}
                                        </v-btn>
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/credit_biz/list_of_loan'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
                        <v-col class="py-0 px-md-2" sm="4" cols="12">
                            <v-card
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <!-- <v-btn :to="lang+'/credit_biz/member'" class="mt-2 text-capitalize font_16 rounded-0 white--text"  color="primary">
                                            + {{$t('member')}}
                                        </v-btn> -->
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/credit_biz/member_list'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                            <v-card
                                ...
                                min-height="338"
                                >
                                <h3 class="font_20 pb-1">{{ $t("par") }}</h3>
                                <p class="mb-0">{{ $t("from_the_beginning") }}</p>
                                <h2 class="primary--text mb-0 niradei_black pa-0 mb-3 col-sm-12 text-right">0%</h2>
                                <v-row>
                                ...
                                <v-row>
                                    <v-col sm="12" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/credit_biz/portfolio_quality'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
                        <v-col class="py-0 px-md-2" sm="4" cols="12">
                            <v-card
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <!-- <v-btn :to="lang+'/credit_biz/share'" class="mt-2 font_16 text-capitalize rounded-0 white--text"  color="primary">
                                            + {{$t('share')}}
                                        </v-btn> -->
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/credit_biz/list_of_share'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                            <v-card
                                ...
                                min-height="338"
                                >
                                <h3 class="font_20 pb-1">{{ $t("saving") }}</h3>
                                <p class="mb-0">{{ $t("from_beginning_year") }}</p>
                                <h2 class="primary--text mb-0 niradei_black pa-0 col-sm-12 text-right">{{totalSavingAmount}}</h2>
                                <v-row>
                                    <v-col sm="12" cols="12" class="pr-0 pb-0">
                                        <template>
                                            <v-simple-table>
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <!-- <v-btn :to="lang+'/credit_biz/saving_account'" class="mt-2 text-capitalize font_16 rounded-0 white--text"  color="primary">
                                            + {{$t('saving')}}
                                        </v-btn> -->
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/credit_biz/list_of_saving'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
