    ...
    <v-app>
        <v-container>
            <v-row>
                    ...
                    <v-row>
                            ...
                            <v-card
                                                ...
                                                <template>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <h2 class="niradei_heavy primary--text niradei_black">
                                                                    {{totalMember}}
                                                                </h2>
                                                            </td>
                                                        </tr>
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <v-btn :to="lang+'/members/member'" class="mt-2 text-capitalize font_16 rounded-0 white--text"  color="primary">
                                            + {{$t('member')}}
                                        </v-btn>
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/members/member_list'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
                        <v-col class="py-0 px-md-2" sm="4" cols="12">
                            <v-card
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <v-btn :to="lang+'/members/share'" class="mt-2 font_16 text-capitalize rounded-0 white--text"  color="primary">
                                            + {{$t('share')}}
                                        </v-btn>
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/members/list_of_share'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
                        <v-col class="py-0 px-md-2" sm="4" cols="12">
                            ...
                            <v-card
                                ...
                                <v-row>
                                    <v-col sm="6" class="pr-0 py-0">
                                        <v-btn :to="lang+'/members/saving_account'" class="mt-2 text-capitalize font_16 rounded-0 white--text"  color="primary">
                                            + {{$t('saving')}}
                                        </v-btn>
                                    </v-col>
                                    <v-col sm="6" class="pl-0 text-right pt-2">
                                        <router-link :to="lang+'/members/list_of_saving'" class="mb-0 py-5 niradei_bold font_16 primary--text text-right">{{$t('view_report')}}</router-link>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
                ...
                <v-col sm="12" cols="12" class="pb-0 px-2">
                    <MemberList/>
                </v-col>
            </v-row>
        </v-container>
...
export default {
    components: {
        // chart: Chart,
        MemberList: () => import('@/views/members/reports/MemberList'),
    },
    data: () => ({
        institutes: [],
        mInstitute: {},
            ...
            new Promise(resolve => {
                setTimeout(() => {
                    ...
                    memberHandler.memberCountGet().then(res => {
                        ...
                        window.console.log(res, 'count member')
                        this.l = res.data.data
                        // this.memberList = res.data.data
                        this.totalMember = this.l[0].totalCount
                        this.totalFemaleMember = this.l[0].totalFemale
                        this.totalMaleMember = this.l[0].totalCount - this.l[0].totalFemale
                        this.loadShare()
                    })
                }, 300);
            })
                        ...
                        memberHandler.listShareReport(data).then(res => {
                            ...
                            if(this.shareList.length > 0){
                                ...
                                $.each(this.shareList, function (i,v){
                                    ...
                                    // window.console.log(self.memberList, 'member')
                                    // window.console.log(v.member, 'share')
                                ...
                                window.console.log(totalShare, this.totalMember, 'share avg')
