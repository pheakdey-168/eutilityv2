    ...
    <v-col sm="12" cols="12" class="pt-0">
      <div style="background-color: #fff; padding: 0 0 5px;">
        ...
        >
          ...
          <v-tab-item>
            <v-row>
              <v-col style="background: #fff" sm="12" cols="12" class="">
...
export default {
  ...
  components: {
    MemberShare: () => import("../reports/MemberShare"),
    MemberSummary: () => import("../reports/MemberSummary"),
    MemberIndicators: () => import("../reports/MemberIndicators"),
    MemberStatistics: () => import("../reports/MemberStatistics"),
  },
};
</script>
<style scoped>
