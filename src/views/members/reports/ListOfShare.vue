    ...
    <v-row>
        <v-col sm="12" cols="12" class="pt-0">
            <v-card color="white" class="pl-2 no_border" elevation="0">
                <v-row>
                    <v-col sm="12" cols="12" class="pt-0">
                        <h2 class="mb-1 font_20">{{ $t('list_of_share') }}</h2>
                    </v-col>
                </v-row>
                <v-row>
                    ...
                    <v-col sm="12" cols="12" class="py-0">
                        <template>
                            ...
                            <kendo-grid
                                ...
                                :sortable="true"
                                :excel-file-name="$t('list_of_share')+'.xlsx'"
...
import { print } from '@/form/member/ListOfShare.js'
