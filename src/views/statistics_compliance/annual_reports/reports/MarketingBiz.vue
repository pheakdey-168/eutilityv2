    ...
    <v-row>
        <v-col sm="12" cols="12" class="pt-0">
            <v-card color="white" class="pl-2 no_border" elevation="0" height= "750" style="overflow-y: scroll;overflow-x: hidden;">
                <v-row>
                    <v-col sm="12" cols="12" class="pt-0">
                        <h2 class="mb-1">{{$t('marketing_biz')}}</h2>
                    </v-col>
                </v-row>
                    ...
                    <v-col sm="12" cols="12" class="py-0">
                        <template>
                            ...
                            <kendo-grid
                                ...
                                :sortable="true"
                                :excel-file-name="$t('marketing_biz')+'.xlsx'"
...
export default {
    ...
    mounted: async function () {
        ...
        ds.add({
            accounts: i18n.t('marketing_revenue_paddy')
        })
        ds.add({
            accounts: i18n.t('marketing_revenue_rice'),
        })
        ds.add({
            accounts: i18n.t('marketing_revenue_vegetables'),
        })
        ds.add({
            accounts: i18n.t('marketing_revenue_chicken'),
        })
        ds.add({
            accounts: i18n.t('marketing_revenue_mango'),
        })
        ds.add({
            accounts: i18n.t('other_revenues'),
        })
        ds.add({
