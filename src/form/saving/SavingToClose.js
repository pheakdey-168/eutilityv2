...
const header = `
<head>
<title>${i18n.t("saving_to_be_close")}</title>
    ...
    data.forEach(element => {
        ...
        items = items + `
            <tr>
                ...
                <td style="border: 1px solid;"> ${element.number}("number")}</td>
                ...
                <td style="border: 1px solid;"> ${element.phoneNumber}</td>
                <td style="border: 1px solid;"> ${element.group}</td>
                <td style="border: 1px solid;"> ${element.issued_date}</td>
                <td style="border: 1px solid;">${element.closing_day}</td>
            ...
            <table class="table" style="width: 100%; border: 1px solid;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid;"> ${i18n.t("closing_day")}</th> 
