...
const header = `
<head>
<title>${i18n.t("list_of_share")}</title>
    ...
    data.forEach(element => {
        ...
        items = items + `
            <tr>
                ...
                <td style="border: 1px solid;">${element.type_of_share}</td>
                <td style="border: 1px solid;"> ${element.share_amount}</td> 
            ...
            <table class="table" style="width: 100%; border: 1px solid;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid;"> ${i18n.t("phone")}</th>
                        ...
                        <th style="border: 1px solid;"> ${i18n.t("type_of_share")}</th> 
                        <th style="border: 1px solid;">${i18n.t("share_amount")}</th>
                        <th style="border: 1px solid;">${i18n.t("withdraw")}</th>
