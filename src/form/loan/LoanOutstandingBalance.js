...
const header = `
<head>
<title>${i18n.t("loan_outstanding_balance_report")}</title>
    ...
    data.forEach(element => {
        ...
        items = items + `
            <tr>
                ...
                <td style="border: 1px solid;"> ${element.open_date}</td>
                <td style="border: 1px solid;">${element.loan_number}</td>
                <td style="border: 1px solid;"> ${element.loan_product}</td> 
                <td style="border: 1px solid;">${element.loan_term}</td>
                <td style="border: 1px solid;">${element.principal}</td>
                <td style="border: 1px solid;">${element.interest}</td>
                <td style="border: 1px solid;">${element.paid_amount}</td>
                <td style="border: 1px solid;">${element.balance}</td>
            </tr>
            `;
            ...
            <table class="table" style="width: 100%; border: 1px solid;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid;"> ${i18n.t("open_date")}</th>
                        <th style="border: 1px solid;"> ${i18n.t("loan_num")}</th> 
                        <th style="border: 1px solid;">${i18n.t("product")}</th>
                        <th style="border: 1px solid;">${i18n.t("loan_term_in_month")}</th>
                        <th style="border: 1px solid;">${i18n.t("principal")}</th>
                        <th style="border: 1px solid;">${i18n.t("interest")}</th>
                        <th style="border: 1px solid;">${i18n.t("paid_amount")}</th>
                        <th style="border: 1px solid;">${i18n.t("balance_credit")}</th>
                    </tr>
                </thead>
                <tbody>
                    ${loadPlay(data)}
