...
const header = `
<head>
<title>${i18n.t("list_of_loan")}</title>
    ...
    data.forEach(element => {
        ...
        items = items + `
            <tr>
                ...
                <td style="border: 1px solid;">${element.loan_amount}</td>
                <td style="border: 1px solid;">${element.disbursed_amount}</td>
            ...
            <table class="table" style="width: 100%; border: 1px solid;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid;">${i18n.t("loan_amount")}</th>
                        <th style="border: 1px solid;">${i18n.t("disbursed_amount")}</th>
