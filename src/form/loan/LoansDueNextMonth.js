...
const header = `
<head>
<title>${i18n.t("list_of_loans_due")}</title>
    ...
    data.forEach(element => {
        ...
        items = items + `
            <tr>
                ...
                <td style="border: 1px solid;"> ${element.payment_date}</td> 
                <td style="border: 1px solid;">${element.loan_term}</td>
                <td style="border: 1px solid;">${element.disburse_amount}</td>
                <td style="border: 1px solid;">${element.balance}</td>
                <td style="border: 1px solid;">${element.principal_due}</td>
            ...
            <table class="table" style="width: 100%; border: 1px solid;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid;">${i18n.t("payment_date")}</th>
                        <th style="border: 1px solid;">${i18n.t("loan_term_in_month")}</th>
                        <th style="border: 1px solid;">${i18n.t("disbursed_amt")}</th>
                        <th style="border: 1px solid;">${i18n.t("balance_credit")}</th>
                        <th style="border: 1px solid;">${i18n.t("principal_due")}</th>
                        <th style="border: 1px solid;">${i18n.t("interest")}</th>
                        <th style="border: 1px solid;">${i18n.t("total_due")}</th>
