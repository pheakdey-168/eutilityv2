    ...
    <div class="">
        ...
        <a href="\" style="margin-top: 15px; float: left">
          <img
              ...
              height="30"
          />
            <span style="margin-top: 9px;" class="text-uppercase primary--text text-bold float-left ml-1">Beta</span>
            <p style="color: #828282; margin-left: 20px; margin-top: -13px;" class="mb-0">{{ planName }}</p>
        </a>
    ...
    data: () => ({
        ...
        items: [
            ...
            },
            {
              ...
              menuTex: "key_ratios_statistics",
              path: "/statistics/key_ratios_statistics",
            },
            {
              id: 3,
              class: "",
              activeClass: "",
              name: "Annual Reports",
              menuTex: "annual_reports",
              path: "/statistics/annual_reports",
            },
            {
              id: 4,
              class: "",
              ...
              menuTex: "financial_ratio",
              path: "/statistics/financial_ratio",
            },
